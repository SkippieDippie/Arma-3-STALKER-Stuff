class cfgPatches
{
	class science_door_dolg
	{
		units[]=
		{
			"land_ARMST_DOLG_door",
			"land_ARMST_DOLG_lab_door",
			"land_ARMST_DOLG_metal_door",
			"land_ARMST_DOLG_metal2_door",
			"land_ARMST_DOLG_lab2_door",
			"land_ARMST_DOLG_metal3_door",
			"land_ARMST_DOLG_wood_door",
			"land_ARMST_DOLG_wood2_door",
			"land_armst_gate_DOLG",
			"land_armst_wood3_door_ARMST_DOLG",
			"land_armst_gate_big_ARMST_DOLG"
		};
		requiredaddons[]=
		{
			"A3_Weapons_F"

...
class CfgVehicles
{
	...
	{
		scope=2;
		displayName="$STR_STST_door_armored_cs_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_lab_cs_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_metal_cs_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_wood_cs_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_gate_cs_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_gate_big_cs_name";

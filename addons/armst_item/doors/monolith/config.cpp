...
class CfgVehicles
{
	...
	{
		scope=2;
		displayName="Бронированная дверь (монолит)";
	...
	{
		scope=2;
		displayName="Лабораторная дверь (монолит)";
	...
	{
		scope=2;
		displayName="Металлическая дверь (монолит)";
	...
	{
		scope=2;
		displayName="Металлическая дверь 2 (монолит)";
	...
	{
		scope=2;
		displayName="Лабораторная дверь 2 (монолит)";
	...
	{
		scope=2;
		displayName="Металлическая дверь 3 (монолит)";
	...
	{
		scope=2;
		displayName="Деревянная дверь (монолит)";
	...
	{
		scope=2;
		displayName="Деревянная дверь 2 (монолит)";
	...
	{
		scope=2;
		displayName="Дверь ворота (монолит)";
	...
	{
		scope=2;
		displayName="Деревянная дверь 3 (монолит)";
	...
	{
		scope=2;
		displayName="Дверь ворота большие (монолит)";

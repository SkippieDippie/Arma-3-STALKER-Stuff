...
class CfgVehicles
{
	...
	{
		scope=2;
		displayName="$STR_STST_door_armored_ecolog_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_lab_ecolog_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_wood_ecolog_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_gate_ecolog_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_gate_big_ecolog_name";

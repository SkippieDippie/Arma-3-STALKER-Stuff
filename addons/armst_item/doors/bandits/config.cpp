...
class CfgVehicles
{
	...
	{
		scope=2;
		displayName="$STR_STST_door_armored_bandit_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_lab_bandits_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_metal_bandits_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_wood_bandits_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_gate_bandits_name";
	...
	{
		scope=2;
		displayName="$STR_STST_door_gate_big_bandits_name";

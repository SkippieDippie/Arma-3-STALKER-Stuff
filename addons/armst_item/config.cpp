...
class cfgWeapons
{
	...
	class armst_item_deshifrator : ItemGPS
	{
		...
		picture = "\armst\armst_item\object\item_pda_ico.paa";
		model = "\armst\armst_item\object\pda.p3d";
		descriptionShort = "Personal decoder for breaking into combination locks.";
	...
	class ARMST_konjak: ACE_ItemCore
	{
			...
			descriptionShort = "A strong alcoholic drink (a type of brandy) produced from certain grape varieties using a special technology. The Zone is of great value.";
			class ItemInfo: CBA_MiscItem_ItemInfo 
			{
				mass = 14;
			};

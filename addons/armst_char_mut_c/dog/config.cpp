...
class CfgPatches
{
	class armst_dog
	{
		...
		{
			"dog_old_test",
			"armst_dog_pastor_black_s",
			"armst_dog_pastor_sandblack_s",
			"armst_dog_pastor_sand_s",
			"armst_dog_fin_blackwhite",
			"armst_dog_fin_ocher",
			"armst_dog_fin_tricolor"
		};
		weapons[]={};
		requiredVersion=0.1;
		requiredAddons[]=
...
class CfgMovesDog_F: CfgMovesBasic
{
	enableDirectControl=1;
...
class CfgVehicles
{
	...
	class dog_old_test: ARMST_MUTANT_HUM
	{
		uniformClass="blinddog_old_testu";
		displayName="dog_old_test";
		faceType="Default";
		moves="CfgMovesDog_F";
		...
		side=1;
		scope=1;
		faction="armst_animals";
		vehicleClass="armst_animals";
		canCarryBackPack=1;
		...
		{
			init="_this spawn ARMST_fnc_initDog";
		};
		class Character
		{
			radius=200;
		...
		class Attributes
		{
			class AnimalAffiliation
			{
				...
				control="combo";
				expression="_this setVariable ['ARM_Animal_Affiliation', _value, true];";
				defaultValue="ARMST_HUMAN";
				unique=0;
				validate="none";
				condition="1";
				typeName="STRING";
			...
			class AnimalCanFollow
			{
				...
				control="combo";
				expression="_this setVariable ['ARM_Animal_CanFollow', _value, true];";
				defaultValue=0;
				unique=0;
				validate="none";
				condition="1";
			...
			class AnimalCanGuard
			{
				...
				control="combo";
				expression="_this setVariable ['ARM_Animal_CanGuard', _value, true];";
				defaultValue=0;
				unique=0;
				validate="none";
				condition="1";
			...
			class AnimalCanSit
			{
				...
				control="combo";
				expression="_this setVariable ['ARM_Animal_CanSit', _value, true];";
				defaultValue=0;
				unique=0;
				validate="none";
				condition="1";
			...
			class AnimalSearchDistance
			{
				...
				control="combo";
				expression="_this setVariable ['ARM_Animal_SearchDistance', _value, true];";
				defaultValue=500;
				unique=0;
				validate="none";
				condition="1";
			...
			class AnimalSearchPeopleA
			{
				...
				control="combo";
				expression="_this setVariable ['ARM_Animal_SearchPeople_A', _value, true];";
				defaultValue=0;
				unique=0;
				validate="none";
				condition="1";
			...
			class AnimalSearchPeopleE
			{
				...
				control="combo";
				expression="_this setVariable ['ARM_Animal_SearchPeople_E', _value, true];";
				defaultValue=0;
				unique=0;
				validate="none";
				condition="1";
			...
			class AnimalSearchObjects
			{
				...
				control="combo";
				expression="_this setVariable ['ARM_Animal_SearchObjects', _value, true];";
				defaultValue=0;
				unique=0;
				validate="none";
				condition="1";
			...
			class Domesticated
			{
				...
				control="combo";
				expression="_this setVariable ['ARM_Animal_Domesticated', _value, true];";
				defaultValue=0;
				unique=0;
				validate="none";
				condition="1";
	...
	class dog_old_test_pastor: dog_old_test
	{
	...
	class armst_dog_pastor_black_s: dog_old_test_pastor
	{
		...
		model="\A3\animals_f_beta\Dog\pastor_F.p3d";
		uniformAccessories[]={};
		nakedUniform="blinddog_old_testu";
		linkedItems[]={};
		nightVision=1;
		scope=2;
		hiddenSelections[]=
	...
	class dog_old_test_fin: dog_old_test
	{
		class Character: Character
		{
			class Sounds

...
class CfgMovesbloodsucker2: CfgMovesBasic
{
	enableDirectControl=1;
	...
	skeletonName="bloodsuckerSkeleton";
	...
	class States
	{
		class krovosos_Stop: StandBase
		{
			...
			duty=-1;
			file="\armst\armst_char\char_mut\bloodsuscker\anim\iddle.rtm";
			variantsAI[]={};
		...
		{
			file="\armst\armst_char\char_mut\bloodsuscker\anim\iddle_t1.rtm";
			speed=0.22;
			looped=1;
			ConnectTo[]=
			{
		...
		class krovosos_attack1: krovosos_angry
		{
			file="\armst\armst_char\char_mut\bloodsuscker\anim\attack.rtm";
			speed=1.3;
		};
		class krovosos_attack2: krovosos_angry
		{
			file="\armst\armst_char\char_mut\bloodsuscker\anim\attack_2.rtm";
			speed=1;
		};
		class krovosos_hvat: krovosos_angry
		{
			file="armst\armst_char\char_mut\bloodsuscker\anim\AttackCling_start";
			speed=0.75;
		};
		class krovosos_hvat_idle: krovosos_angry
		{
			file="armst\armst_char\char_mut\bloodsuscker\anim\AttackCling_loop";
			speed=0.40000001;
		};
		class krovosos_Eat: krovosos_angry
		{
			file="armst\armst_char\char_mut\bloodsuscker\anim\AttackCling_start";
			speed=0.75;
		};
		...
		{
			file="\armst\armst_char\char_mut\bloodsuscker\anim\walk.rtm";
			speed=1;
			ConnectTo[]=
			{
				"krovosos_Stop",
		...
		class krovosos_Sprint: krovosos_Stop
		{
			...
			file="\armst\armst_char\char_mut\bloodsuscker\anim\run.rtm";
			speed=1.1485;
			duty=0.5;
			soundOverride="sprint";
			soundEnabled=1;
		...
		{
			file="\armst\armst_char\char_mut\bloodsuscker\anim\dead.rtm";
			speed=0.625;
			looped=0;
			onLandBeg=1;
			onLandEnd=1;

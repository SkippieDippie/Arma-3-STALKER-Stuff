...
class CfgMovessnork: CfgMovesBasic
{
	enableDirectControl=1;
	...
	skeletonName="snorkSkeleton";
	gestures="CfgGestures_CfgMovessnork";
	...
	class States
	{
		class snork_Stop: StandBase
		{
			actions="snorkActions";
			duty=-1;
			soundOverride="sprint";
			soundEnabled=1;
			soundEdge[]={0.050000001};
			file="\armst\armst_char\char_mut\snork_old\anim\idle1.rtm";
			variantsAI[]={};
			variantAfter[]={0,2,3};
			speed=0.30000001;
		...
		class snork_angry: snork_Stop
		{
			file="\armst\armst_char\char_mut\snork_old\anim\eat.rtm";
			speed=0.5;
			looped=1;
			ConnectTo[]=
			{
		...
		class snork_attack1: snork_angry
		{
			file="\armst\armst_char\char_mut\snork_old\anim\attack1.rtm";
			speed=1.5;
		};
		class snork_attack2: snork_angry
		{
			file="\armst\armst_char\char_mut\snork_old\anim\attack2.rtm";
			speed=1.5;
		};
		class snork_attack3: snork_angry
		{
			file="\armst\armst_char\char_mut\snork_old\anim\attack3.rtm";
			speed=1.5;
		};
		class snork_TurnL: snork_Stop
		{
			file="\armst\armst_char\char_mut\snork_old\anim\walk.rtm";
			speed=1;
			ConnectTo[]=
			{
				"snork_Stop",
		...
		class snork_StopV1: snork_Stop
		{
			file="\armst\armst_char\char_mut\snork_old\anim\idle2.rtm";
			speed=0.25;
			looped=1;
			ConnectTo[]=
			{
		...
		class snork_StopV2: snork_Stop
		{
			file="\armst\armst_char\char_mut\snork_old\anim\idle3.rtm";
			speed=0.34999999;
			looped=1;
			ConnectTo[]=
			{
		...
		class snork_Sprint: snork_Stop
		{
			actions="snorkSprint";
			file="\armst\armst_char\char_mut\snork_old\anim\run.rtm";
			speed=1.99;
			soundOverride="sprint";
			soundEnabled=1;
			soundEdge[]={0.050000001};
		...
		class snork_Die: DefaultDie
		{
			file="\armst\armst_char\char_mut\snork_old\anim\dead.rtm";
			speed=0.625;
			looped=0;
			onLandBeg=1;
			onLandEnd=1;
	...
	class Actions: Actions
	{
		...
		class snorkActions: NoActions
		{
			Stop="snork_Stop";
			StopRelaxed="snork_StopV2";
			TurnL="snork_TurnL";
			TurnR="snork_TurnR";
			TurnLRelaxed="snork_TurnL";
			TurnRRelaxed="snork_TurnR";
			Default="snork_StopV1";
			JumpOff="snork_Run";
			WalkF="snork_Walk";
			SlowF="snork_Run";
			FastF="snork_Sprint";
			EvasiveForward="snork_Sprint";
			Down="snork_StopV1";
			Up="snork_Run";
			PlayerStand="snork_Run";
			PlayerProne="snork_Run";
			PlayerCrouch="snork_StopV1";
			Crouch="snork_StopV1";
			Lying="snork_StopV2";
			Stand="snork_Run";
			Combat="snork_Sprint";
			CanNotMove="snork_StopV2";
			Civil="snork_Run";
			CivilLying="snork_StopV2";
			FireNotPossible="snork_Run";
			Die="snork_Die";
			turnSpeed=1;
			limitFast=1.5;
			useFastMove=0;
		...
		class snorkSprint: snorkActions
		{
			Die="snork_Die";
			TurnL="snork_TurnL";
			TurnR="snork_TurnR";
...
class CfgGestures_CfgMovessnork
{
	skeletonName="snorkSkeleton";
	class ManActions
	{

...
class CfgMovestushkano: CfgMovesBasic
{
	enableDirectControl=1;
	...
	skeletonName="tushkanoSkeleton";
	gestures="CfgGestures_CfgMovestushkano";
	...
	class States
	{
		class tushkano_Stop: StandBase
		{
			actions="tushkanoActions";
			duty=-1;
			soundOverride="sprint";
			soundEnabled=1;
			soundEdge[]={0.050000001};
			file="\armst\armst_char\char_mut\tushkano_old\anim\idle1.rtm";
			variantsAI[]={};
			variantAfter[]={0,2,3};
			speed=0.30000001;
		...
		class tushkano_angry: tushkano_Stop
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\eat.rtm";
			speed=0.5;
			looped=1;
			ConnectTo[]=
			{
		...
		class tushkano_attack1: tushkano_angry
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\attack1.rtm";
			speed=1.5;
		};
		class tushkano_attack2: tushkano_angry
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\attack2.rtm";
			speed=1.5;
		};
		class tushkano_attack3: tushkano_angry
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\attack3.rtm";
			speed=1.5;
		};
		class tushkano_TurnL: tushkano_Stop
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\walk.rtm";
			speed=1;
			ConnectTo[]=
			{
				"tushkano_Stop",
		...
		class tushkano_TurnR: tushkano_TurnL
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\walk.rtm";
			speed=1;
			ConnectTo[]=
		...
		class tushkano_StopV1: tushkano_Stop
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\idle2.rtm";
			speed=0.25;
			looped=1;
			ConnectTo[]=
			{
		...
		class tushkano_StopV2: tushkano_Stop
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\idle3.rtm";
			speed=0.34999999;
			looped=1;
			ConnectTo[]=
			{
		...
		class tushkano_Sprint: tushkano_Stop
		{
			actions="tushkanoSprint";
			file="\armst\armst_char\char_mut\tushkano_old\anim\run.rtm";
			speed=1.99;
			duty=0.5;
			soundOverride="sprint";
			soundEnabled=1;
		...
		class tushkano_Run: tushkano_Stop
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\run.rtm";
			speed=1.99;
			duty=-0.5;
		...
		class tushkano_Walk: tushkano_Stop
		{
			duty=-0.69999999;
			file="\armst\armst_char\char_mut\tushkano_old\anim\walk.rtm";
			speed=1;
		...
		class tushkano_Die: DefaultDie
		{
			file="\armst\armst_char\char_mut\tushkano_old\anim\dead.rtm";
			speed=0.625;
			looped=0;
			onLandBeg=1;
			onLandEnd=1;
	...
	class Actions: Actions
	{
		...
		class tushkanoActions: NoActions
		{
			Stop="tushkano_Stop";
			StopRelaxed="tushkano_StopV2";
			TurnL="tushkano_TurnL";
			TurnR="tushkano_TurnR";
			TurnLRelaxed="tushkano_TurnL";
			TurnRRelaxed="tushkano_TurnR";
			Default="tushkano_StopV1";
			JumpOff="tushkano_Run";
			WalkF="tushkano_Walk";
			SlowF="tushkano_Run";
			FastF="tushkano_Sprint";
			EvasiveForward="tushkano_Sprint";
			Down="tushkano_StopV1";
			Up="tushkano_Run";
			PlayerStand="tushkano_Run";
			PlayerProne="tushkano_Run";
			PlayerCrouch="tushkano_StopV1";
			Crouch="tushkano_StopV1";
			Lying="tushkano_StopV2";
			Stand="tushkano_Run";
			Combat="tushkano_Sprint";
			CanNotMove="tushkano_StopV2";
			Civil="tushkano_Run";
			CivilLying="tushkano_StopV2";
			FireNotPossible="tushkano_Run";
			Die="tushkano_Die";
			turnSpeed=1;
			limitFast=1.5;
			useFastMove=0;
			upDegree="ManPosNoWeapon";
			StartSwim="tushkano_Die";
		};
		class tushkanoSprint: tushkanoActions
		{
			Die="tushkano_Die";
			TurnL="tushkano_TurnL";
			TurnR="tushkano_TurnR";
...
class CfgGestures_CfgMovestushkano
{
	skeletonName="tushkanoSkeleton";
	class ManActions
	{

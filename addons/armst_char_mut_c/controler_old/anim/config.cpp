...
class CfgMovescontroler: CfgMovesBasic
{
	enableDirectControl=1;
	...
	skeletonName="controlerSkeleton";
	gestures="CfgGestures_CfgMovescontroler";
	...
	class States
	{
		class controler_Stop: StandBase
		{
			actions="controlerActions";
			duty=-1;
			file="\armst\armst_char\char_mut\controler_old\anim\idle1.rtm";
			variantsAI[]={};
			variantAfter[]={0,2,3};
			speed=0.75;
		...
		class controler_angry: controler_Stop
		{
			file="\armst\armst_char\char_mut\controler_old\anim\idle1.rtm";
			speed=0.2;
			looped=1;
		...
		class controler_attack1: controler_angry
		{
			file="\armst\armst_char\char_mut\controler_old\anim\attack.rtm";
			speed=1.35;
		};
		class controler_attack2: controler_angry
		{
			file="\armst\armst_char\char_mut\controler_old\anim\attack_psy.rtm";
			speed=1;
		};
		class controler_Eat: controler_angry
		{
			file="\armst\armst_char\char_mut\controler_old\anim\eat.rtm";
			speed=0.30000001;
		};
		class controler_sit: controler_angry
		{
			file="\armst\armst_char\char_mut\controler_old\anim\sit.rtm";
			speed=0.2;
		};
		class controler_controll: controler_angry
		{
			file="\armst\armst_char\char_mut\controler_old\anim\controll.rtm";
			speed=1;
		};
		class controler_TurnL: controler_Stop
		{
			file="\armst\armst_char\char_mut\controler_old\anim\walk.rtm";
			speed=0.2;
			ConnectTo[]=
			{
				"controler_Stop",
		...
		class controler_TurnR: controler_TurnL
		{
			file="\armst\armst_char\char_mut\controler_old\anim\walk.rtm";
			speed=0.2;
			ConnectTo[]=
		...
		class controler_StopV1: controler_Stop
		{
			file="\armst\armst_char\char_mut\controler_old\anim\idle2.rtm";
			speed=0.5;
			looped=1;
			ConnectTo[]=
			{
		...
		class controler_StopV2: controler_Stop
		{
			file="\armst\armst_char\char_mut\controler_old\anim\idle3.rtm";
			speed=0.40000001;
			looped=1;
			ConnectTo[]=
			{
		...
		class controler_StopV3: controler_Stop
		{
			file="\armst\armst_char\char_mut\controler_old\anim\idle4.rtm";
			speed=0.5;
			looped=1;
			ConnectTo[]=
			{
		...
		class controler_Sprint: controler_Stop
		{
			actions="controlerSprint";
			file="\armst\armst_char\char_mut\controler_old\anim\run.rtm";
			speed=2.0999999;
			duty=0.5;
		...
		class controler_Run: controler_Stop
		{
			file="\armst\armst_char\char_mut\controler_old\anim\run.rtm";
			speed=2.0999999;
			duty=-0.5;
		...
		class controler_Walk: controler_Stop
		{
			duty=-0.69999999;
			file="\armst\armst_char\char_mut\controler_old\anim\walk.rtm";
			speed=0.2;
		...
		class controler_Die: DefaultDie
		{
			file="\armst\armst_char\char_mut\controler_old\anim\dead.rtm";
			speed=0.625;
			looped=0;
			onLandBeg=1;
			onLandEnd=1;
	...
	class Actions: Actions
	{
		...
		class controlerActions: NoActions
		{
			Stop="controler_Stop";
			StopRelaxed="controler_StopV2";
			TurnL="controler_TurnL";
			TurnR="controler_TurnR";
			TurnLRelaxed="controler_TurnL";
			TurnRRelaxed="controler_TurnR";
			Default="controler_StopV1";
			JumpOff="controler_Run";
			WalkF="controler_Walk";
			SlowF="controler_Run";
			FastF="controler_Sprint";
			EvasiveForward="controler_Sprint";
			Down="controler_StopV1";
			Up="controler_Run";
			PlayerStand="controler_Run";
			PlayerProne="controler_Run";
			PlayerCrouch="controler_StopV1";
			Crouch="controler_StopV1";
			Lying="controler_StopV2";
			Stand="controler_Run";
			Combat="controler_Sprint";
			CanNotMove="controler_StopV2";
			Civil="controler_Run";
			CivilLying="controler_StopV2";
			FireNotPossible="controler_Run";
			Die="controler_Die";
			turnSpeed=1;
			limitFast=1.5;
			useFastMove=0;
			upDegree="ManPosNoWeapon";
			StartSwim="controler_Die";
		};
		class controlerSprint: controlerActions
		{
			Die="controler_Die";
			TurnL="controler_TurnL";
			TurnR="controler_TurnR";
...
class CfgGestures_CfgMovescontroler
{
	skeletonName="controlerSkeleton";
	class ManActions
	{

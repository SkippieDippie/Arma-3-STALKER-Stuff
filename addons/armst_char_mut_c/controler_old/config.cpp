...
class CfgVehicles
{
	...
	class controler_old_test: ARMST_MUTANT_HUM
	{
		...
		{
			"armst\armst_char\char_mut\controler_old\controler.paa"
		};
		attendant=1;
		weapons[]={};
		magazines[]={};
		...
		{
			init="[_this select 0, localize 'str_cutmutants','','','_this distance _target < 2 && !(alive _target) && isNil {_target getVariable ""RemainsEmpty""}','true',{},{player playmove 'AinvPknlMstpSnonWnonDnon_medic_1'},{[_target] spawn Armst_fnc_kontroller_remains},{},[],15,nil,false,false] call BIS_fnc_holdActionAdd;";
		};
		class Character
		{
			radius=200;
	...
	class armst_controler2: controler_old_test
	{
		...
		hiddenSelectionsTextures[]=
		{
			"armst\armst_char\char_mut\controler_old\controler2.paa"
		};
	};
	class armst_controler3: controler_old_test
	{
		...
		hiddenSelectionsTextures[]=
		{
			"armst\armst_char\char_mut\controler_old\controler3.paa"
		};
	};
	class armst_controler4: controler_old_test
	{
		...
		hiddenSelectionsTextures[]=
		{
			"armst\armst_char\char_mut\controler_old\controler4.paa"
		};
	};
	class armst_controler5: controler_old_test
	{
		...
		uniformAccessories[]={};
		linkedItems[]={};
		nakedUniform="controler_old5";
		nightVision=1;
		scope=2;
		model="armst\armst_char\char_mut\controler_old\2\controler.p3d";
	};
};

...
class CfgMovesizlom: CfgMovesBasic
{
	enableDirectControl=1;
	...
	skeletonName="izlomSkeleton";
	gestures="CfgGestures_CfgMovesizlom";
	...
	class States
	{
		class izlom_Stop: StandBase
		{
			actions="izlomActions";
			duty=-1;
			file="\armst\armst_char\char_mut\izlom_old\anim\idle1.rtm";
			variantsAI[]={};
		...
		class izlom_angry: izlom_Stop
		{
			file="\armst\armst_char\char_mut\izlom_old\anim\angry.rtm";
			speed=0.34;
			looped=1;
			ConnectTo[]=
			{
		...
		class izlom_attack1: izlom_angry
		{
			file="\armst\armst_char\char_mut\izlom_old\anim\attack1.rtm";
			speed=1.55;
		};
		class izlom_Eat: izlom_angry
		{
			file="\armst\armst_char\char_mut\izlom_old\anim\eat.rtm";
			speed=0.5;
		};
		class izlom_TurnL: izlom_Stop
		{
			file="\armst\armst_char\char_mut\izlom_old\anim\walk.rtm";
			speed=1;
			ConnectTo[]=
			{
				"izlom_Stop",
		...
		class izlom_StopV1: izlom_Stop
		{
			file="\armst\armst_char\char_mut\izlom_old\anim\idle2.rtm";
			speed=0.5;
			looped=1;
			ConnectTo[]=
			{
		...
		class izlom_StopV3: izlom_Stop
		{
			file="\armst\armst_char\char_mut\izlom_old\anim\idle3.rtm";
			speed=0.2;
			looped=1;
			ConnectTo[]=
			{
		...
		class izlom_Sprint: izlom_Stop
		{
			actions="izlomSprint";
			file="\armst\armst_char\char_mut\izlom_old\anim\run.rtm";
			speed=1.5;
			duty=0.5;
			soundOverride="sprint";
			soundEnabled=1;
		...
		class izlom_Die: DefaultDie
		{
			file="\armst\armst_char\char_mut\izlom_old\anim\dead.rtm";
			speed=0.625;
			looped=0;
			onLandBeg=1;
			onLandEnd=1;
	...
	class Actions: Actions
	{
		...
		class izlomActions: NoActions
		{
			Stop="izlom_Stop";
			StopRelaxed="izlom_StopV2";
			TurnL="izlom_TurnL";
			TurnR="izlom_TurnR";
			TurnLRelaxed="izlom_TurnL";
			TurnRRelaxed="izlom_TurnR";
			Default="izlom_StopV1";
			JumpOff="izlom_Run";
			WalkF="izlom_Walk";
			SlowF="izlom_Run";
			FastF="izlom_Sprint";
			EvasiveForward="izlom_Sprint";
			Down="izlom_StopV1";
			Up="izlom_Run";
			PlayerStand="izlom_Run";
			PlayerProne="izlom_Run";
			PlayerCrouch="izlom_StopV1";
			Crouch="izlom_StopV1";
			Lying="izlom_StopV2";
			Stand="izlom_Run";
			Combat="izlom_Sprint";
			CanNotMove="izlom_StopV2";
			Civil="izlom_Run";
			CivilLying="izlom_StopV2";
			FireNotPossible="izlom_Run";
			Die="izlom_Die";
			turnSpeed=1;
			limitFast=1.5;
			useFastMove=0;
		...
		class izlomSprint: izlomActions
		{
			Die="izlom_Die";
			TurnL="izlom_TurnL";
			TurnR="izlom_TurnR";
...
class CfgGestures_CfgMovesizlom
{
	skeletonName="izlomSkeleton";
	class ManActions
	{

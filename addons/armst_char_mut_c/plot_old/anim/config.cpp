...
class CfgGestures_CfgMovesPLOT2
{
	skeletonName="plotSkeleton";
	class ManActions
	{
	};
	class Actions
...
class CfgMovesPLOT2: CfgMovesBasic
{
	enableDirectControl=1;
	...
	skeletonName="plotSkeleton";
	gestures="CfgGestures_CfgMovesPLOT2";
	...
	class States
	{
		class plot_Stop: StandBase
		{
			actions="plotActions";
			duty=-1;
			file="\armst\armst_char\char_mut\plot_old\anim\iddle1.rtm";
			variantsAI[]={};
		...
		class plot_angry: plot_Stop
		{
			file="\armst\armst_char\char_mut\plot_old\anim\iddle5.rtm";
			speed=0.1;
			looped=1;
			ConnectTo[]=
			{
		...
		class plot_attack1: plot_angry
		{
			file="\armst\armst_char\char_mut\plot_old\anim\attack1.rtm";
			speed=0.55000001;
		};
		class plot_attack2: plot_angry
		{
			file="\armst\armst_char\char_mut\plot_old\anim\attack2.rtm";
			speed=0.94999999;
		};
		class plot_attack3: plot_angry
		{
			file="\armst\armst_char\char_mut\plot_old\anim\attack3.rtm";
			speed=0.94999999;
		};
		class plot_TurnL: plot_Stop
		{
			speed=0.2;
			file="\armst\armst_char\char_mut\plot_old\anim\walk.rtm";
			ConnectTo[]=
			{
				"plot_Stop",
				0.1
		...
		class plot_StopV1: plot_Stop
		{
			file="\armst\armst_char\char_mut\plot_old\anim\iddle2.rtm";
			speed=0.25;
			looped=1;
			ConnectTo[]=
			{
		...
		class plot_StopV2: plot_Stop
		{
			file="\armst\armst_char\char_mut\plot_old\anim\iddle3.rtm";
			speed=0.2;
			looped=1;
			ConnectTo[]=
			{
		...
		class plot_Sprint: plot_Stop
		{
			actions="plotSprint";
			file="\armst\armst_char\char_mut\plot_old\anim\run.rtm";
			speed=0.40000001;
			duty=0.5;
			soundOverride="sprint";
			soundEnabled=1;
		...
		class plot_Die: DefaultDie
		{
			file="\armst\armst_char\char_mut\plot_old\anim\dead.rtm";
			speed=0.625;
			looped=0;
			onLandBeg=1;
			onLandEnd=1;
	...
	class Actions: Actions
	{
		...
		class plotActions: NoActions
		{
			Stop="plot_Stop";
			StopRelaxed="plot_StopV2";
			TurnL="plot_TurnL";
			TurnR="plot_TurnR";
			TurnLRelaxed="plot_TurnL";
			TurnRRelaxed="plot_TurnR";
			Default="plot_StopV1";
			JumpOff="plot_Run";
			WalkF="plot_Walk";
			SlowF="plot_Run";
			FastF="plot_Sprint";
			EvasiveForward="plot_Sprint";
			Down="plot_StopV1";
			Up="plot_Run";
			PlayerStand="plot_Run";
			PlayerProne="plot_Run";
			PlayerCrouch="plot_StopV1";
			Crouch="plot_StopV1";
			Lying="plot_StopV2";
			Stand="plot_Run";
			Combat="plot_Sprint";
			CanNotMove="plot_StopV2";
			Civil="plot_Run";
			CivilLying="plot_StopV2";
			FireNotPossible="plot_Run";
			Die="plot_Die";
			turnSpeed=1;
			limitFast=1.5;
			useFastMove=0;

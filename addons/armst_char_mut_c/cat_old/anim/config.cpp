...
class CfgMovescat: CfgMovesBasic
{
	enableDirectControl=1;
	...
	skeletonName="catSkeleton";
	gestures="CfgGestures_CfgMovescat";
	...
	class States
	{
		class cat_Stop: StandBase
		{
			...
			file="\armst\armst_char\char_mut\cat_old\anim\idle1.rtm";
			variantsAI[]={};
			variantAfter[]={0,2,3};
			speed=0.69999999;
		...
		class cat_angry: cat_Stop
		{
			file="\armst\armst_char\char_mut\cat_old\anim\angry.rtm";
			speed=0.80000001;
			looped=1;
			ConnectTo[]=
			{
		...
		class cat_attack1: cat_angry
		{
			file="\armst\armst_char\char_mut\cat_old\anim\attack1.rtm";
			speed=1;
		};
		class cat_attack2: cat_angry
		{
			file="\armst\armst_char\char_mut\cat_old\anim\attack2.rtm";
			speed=1;
		};
		class cat_TurnL: cat_Stop
		{
			file="\armst\armst_char\char_mut\cat_old\anim\walk.rtm";
			speed=0.5;
			ConnectTo[]=
			{
				"cat_Stop",
		...
		class cat_StopV1: cat_Stop
		{
			file="\armst\armst_char\char_mut\cat_old\anim\idle2.rtm";
			speed=0.44999999;
			looped=1;
			ConnectTo[]=
			{
		...
		class cat_eat: cat_Stop
		{
			file="\armst\armst_char\char_mut\cat_old\anim\eat.rtm";
			speed=0.64999998;
			looped=1;
			ConnectTo[]=
			{
		...
		class cat_Sprint: cat_Stop
		{
			actions="catSprint";
			file="\armst\armst_char\char_mut\cat_old\anim\run.rtm";
			speed=2.2;
			duty=0.5;
			soundOverride="sprint";
			soundEnabled=1;
		...
		class cat_Die: DefaultDie
		{
			file="\armst\armst_char\char_mut\cat_old\anim\dead.rtm";
			speed=0.625;
			looped=0;
			onLandBeg=1;
			onLandEnd=1;
	...
	class Actions: Actions
	{
		...
		class catActions: NoActions
		{
			Stop="cat_Stop";
			StopRelaxed="cat_StopV2";
			TurnL="cat_TurnL";
			TurnR="cat_TurnR";
			TurnLRelaxed="cat_TurnL";
			TurnRRelaxed="cat_TurnR";
			Default="cat_StopV1";
			JumpOff="cat_Run";
			WalkF="cat_Walk";
			SlowF="cat_Run";
			FastF="cat_Sprint";
			EvasiveForward="cat_Sprint";
			Down="cat_StopV1";
			Up="cat_Run";
			PlayerStand="cat_Run";
			PlayerProne="cat_Run";
			PlayerCrouch="cat_StopV1";
			Crouch="cat_StopV1";
			Lying="cat_StopV2";
			Stand="cat_Run";
			Combat="cat_Sprint";
			CanNotMove="cat_StopV2";
			Civil="cat_Run";
			CivilLying="cat_StopV2";
			FireNotPossible="cat_Run";
			Die="cat_Die";
			turnSpeed=1;
			limitFast=1.5;
			useFastMove=0;

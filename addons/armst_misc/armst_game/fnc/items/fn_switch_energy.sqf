...
_unit removeitem "ARMST_item_energy";  
_unit addweapon "armst_switch_energy"; 
[_unit] call AGM_WeaponSelect_fnc_putWeaponAway;  
sleep 1; 
_unit selectWeapon "armst_switch_energy"; 
...
_unit setFatigue 0;
sleep 7;  
_unit removeweapon "armst_switch_energy";  
_unit additem "ARMST_item_energyempty";  

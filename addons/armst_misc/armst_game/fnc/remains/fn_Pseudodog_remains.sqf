...
_parts = random 10;
if (_parts < 5) then { ARMST_PARTS = "Armst_mut_psevdog_meh"};
if ((_parts >= 5) && (_parts < 8)) then { ARMST_PARTS = "Armst_mut_psevdog"};
if (_parts >= 8) then { ARMST_PARTS = "Armst_mut_psevdog_mozg"};
	if (true) then
	{       

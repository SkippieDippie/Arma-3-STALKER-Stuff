...
_parts = random 10;
if (_parts < 5) then { ARMST_PARTS = "Armst_mut_tushkano_meat"};
if ((_parts >= 5) && (_parts < 8)) then { ARMST_PARTS = "Armst_mut_tushkano_kogot"};
if (_parts >= 8) then { ARMST_PARTS = "Armst_mut_tushkano"};
	if (true) then
	{       

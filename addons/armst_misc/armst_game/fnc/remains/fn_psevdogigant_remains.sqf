...
_parts = random 10;
if (_parts < 5) then { ARMST_PARTS = "Armst_mut_psevdogigant_eye"};
if ((_parts >= 5) && (_parts < 8)) then { ARMST_PARTS = "Armst_mut_psevdogigant"};
if (_parts >= 8) then { ARMST_PARTS = "Armst_mut_psevdogigant_heart"};
	if (true) then
	{       

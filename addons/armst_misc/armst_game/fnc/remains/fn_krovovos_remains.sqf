...
_parts = random 10;
if (_parts < 5) then { ARMST_PARTS = "Armst_mut_krovosos_shkura"};
if ((_parts >= 5) && (_parts < 8)) then { ARMST_PARTS = "Armst_mut_krovosos"};
if (_parts >= 8) then { ARMST_PARTS = "Armst_mut_krovosos_heart"};
	if (true) then
	{       

...
_parts = random 10;
if (_parts < 5) then { ARMST_PARTS = "Armst_mut_poltergeist_hand"};
if ((_parts >= 5) && (_parts < 8)) then { ARMST_PARTS = "Armst_mut_poltergeist"};
if (_parts >= 8) then { ARMST_PARTS = "Armst_mut_poltergeist_scalp"};
	if (true) then
	{       

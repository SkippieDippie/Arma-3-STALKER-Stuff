...
_parts = random 10;
if (_parts < 5) then { ARMST_PARTS = "Armst_mut_burer2"};
if ((_parts >= 5) && (_parts < 8)) then { ARMST_PARTS = "Armst_mut_burer_heart"};
if (_parts >= 8) then { ARMST_PARTS = "Armst_mut_burer_mozg"};

	...
	*/
	...
	_startingdate = [2018, 07, 01, 07, 00];
	...
	while {true} do {
	   ...
	   player setObjectMaterialGlobal [0, "armst\armst_misc\armst_game\data\rain.rvmat"]; 
	   player setObjectMaterialGlobal [1, "armst\armst_misc\armst_game\data\rain.rvmat"];
		} else {
			[player, "makeDry", "1"] spawn RS_fnc_GearSwitch;
		};

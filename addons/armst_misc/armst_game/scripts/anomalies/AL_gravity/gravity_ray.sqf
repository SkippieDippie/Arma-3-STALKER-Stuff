...
[[[_grav_source],"\armst\armst_misc\armst_game\scripts\anomalies\AL_gravity\gravity_ray_effect.sqf"],"BIS_fnc_execVM",true,false] spawn BIS_fnc_MP;
...
_nearobjects = nearestObjects[_grav_source,[],100];
[] spawn {
	while {cutremur} do {

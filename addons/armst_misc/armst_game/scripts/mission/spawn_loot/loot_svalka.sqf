...
itemsLoot=		["acc_flashlight","Binocular","AGM_CableTie","armst_MESHOK","Armst_item_tushonka","Armst_spicki","ARMST_book_manual","ARMST_book_novel",
...
"armst_kevlar","armst_lopatka","armst_skipidar","armst_broneplastina","armst_brokenradio","armst_brokenpda","armst_zeton","armst_polhir","armst_medinst",
"armst_medperchatki","armst_scaner","armst_scanerart","armst_doska","armst_bochka","armst_545","armst_762","armst_steklo",
"armst_armst_korob1","armst_svecha","armst_karburator","armst_tkan","armst_brezent","armst_pallet_vertical"];

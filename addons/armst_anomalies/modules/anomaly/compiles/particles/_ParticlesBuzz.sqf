...
---------------------------------------------------------------------------- */
	...
	_light = "#lightpoint" createVehicleLocal _this;
	 ...
	 _light setLightAmbient[0,1,0.141];
	 _light setLightColor[0,1,0.141];
	...
	"Billboard", 10, 10, [0,0,-0.3], [0,0,0], 0, 0.3, 0.2353, 0, [1], [[0.3,0.6,0.1,1]], [1], 0, 0, "", "", "",0,true];
	...
	"Billboard", 10, 10, [0,0,0], [0,0,0], 0, 0.3, 0.2353, 0, [1.2], [[0.1,0.8,0,0.1]], [0.5], 0, 0, "", "", "",0,true];

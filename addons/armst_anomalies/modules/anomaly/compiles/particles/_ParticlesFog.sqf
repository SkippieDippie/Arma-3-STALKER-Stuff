...
_PS = "#particlesource" createVehiclelocal _this;
        ...
        ["\A3\Data_F\ParticleEffects\Universal\universal.p3d" , 16, 12, 15, 0], "", "Billboard", 1, 20, 
            [0, 0, -1], [0, 0, 0], 1, 1.275, 1, 0, 
            [7,6], [[1, 1, 1, 0.05], [1, 1, 1, 0], [1, 1, 1, 0]], [1000], 1, 0, "", "", true 
        ]; 
        _PS setParticleRandom [3, [40, 40, 0.2], [0, 0, -0.1], 2, 0.45, [0, 0, 0, 0.1], 0, 0]; 

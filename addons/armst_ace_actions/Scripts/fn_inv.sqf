...
ARMST_dragster_dblclick_on_item={
	...
	switch (_item) do { 
		...
		case "armst_item_antirad" : 	{  (findDisplay 602) closeDisplay 100;[player] execVM "Scripts\fn_radX_health.sqf";}; 
		...
		case "armst_item_stimul_hp" : 		{  (findDisplay 602) closeDisplay 100;uiSleep 0.3;[] spawn Armst_fnc_item_stimul_hp;      	 };

...
class medicine
{
	...
	class Controls {
		class head: RscButton
		{
			...
			onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 1);['HitHead'] spawn armst_fnc_med_bandage;";
		};
		class body: RscButton
		{
			...
			colorFocused[] = {0,0,0,0.2};
			colorBackgroundActive[] = {0,0,0,0.2};
			onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 1);['HitBody'] spawn armst_fnc_med_bandage;";
		};
		class left_arm: RscButton
		{
			...
			colorFocused[] = {0,0,0,0.2};
			colorBackgroundActive[] = {0,0,0,0.2};
			onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 1);['HitLeftArm'] spawn armst_fnc_med_bandage;";
		};
		class right_arm: RscButton
		{
			...
			colorFocused[] = {0,0,0,0.2};
			colorBackgroundActive[] = {0,0,0,0.2};
			onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 1);['HitRightArm'] spawn armst_fnc_med_bandage;";
		};
		class left_leg: RscButton
		{
			...
			colorFocused[] = {0,0,0,0.2};
			colorBackgroundActive[] = {0,0,0,0.2};
			onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 1);['HitLeftLeg'] spawn armst_fnc_med_bandage;";
		};
		class right_leg: RscButton
		{
			...
			colorFocused[] = {0,0,0,0.2};
			colorBackgroundActive[] = {0,0,0,0.2};
			onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 1);['HitRightLeg'] spawn armst_fnc_med_bandage;";
		};

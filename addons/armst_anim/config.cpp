...
class CfgMovesBasic
{
	...
	class ManActions
	{
		...
		Gesture_Remains_0[] = {"Gesture_Remains_0","Gesture"};
		Gesture_Remains_5[] = {"Gesture_Remains_5","Gesture"};
		Gesture_Remains_10[] = {"Gesture_Remains_10","Gesture"};
		Gesture_Remains_15[] = {"Gesture_Remains_15","Gesture"};
		armst_injection[] = {"armst_injection","Gesture"};
		armst_bandage[] = {"armst_bandage","Gesture"};
		armst_bandage_0_level[] = {"armst_bandage_0_level","Gesture"};
		armst_bandage_5_level[] = {"armst_bandage_5_level","Gesture"};
		armst_bandage_10_level[] = {"armst_bandage_10_level","Gesture"};
		armst_injection_0_level[] = {"armst_injection_0_level","Gesture"};
		armst_injection_5_level[] = {"armst_injection_5_level","Gesture"};
		armst_injection_10_level[] = {"armst_injection_10_level","Gesture"};
		armst_injection_15_level[] = {"armst_injection_15_level","Gesture"};
		armst_medkit_0_level[] = {"armst_medkit_0_level","Gesture"};
		armst_medkit_10_level[] = {"armst_medkit_10_level","Gesture"};
		armst_medkit_15_level[] = {"armst_medkit_15_level","Gesture"};
		armst_medkit_20_level[] = {"armst_medkit_20_level","Gesture"};
		armst_repair[] = {"armst_repair","Gesture"};
		armst_injection_target[] = {"armst_injection_target","Gesture"};
		armst_bandage_target[] = {"armst_bandage_target","Gesture"};
		armst_vomit[] = {"armst_vomit","Gesture"};
		armst_OZK[] = {"armst_OZK","Gesture"};
	};
};
class CfgGesturesMale
{
	...
	class States
	{
		class armst_vomit: Default
		{
			looped = 0;
			mask = "BodyFull2";
			file = "\armst\armst_anim\armst_vomit.rtm";
			speed = 0.1478;
		...
		class armst_injection_target: Default
		{
			looped = 1;
			mask = "handsWeapon_melee";
			file = "\A3\anims_f\Data\Anim\Sdr\inj\HEALING\AinvPknlMstpSnonWnonDnon_medicUp1";
			speed = 0.2;
			leftHandIKCurve[] = {};
			rightHandIKCurve[] = {};
			weaponIK = 1;
		...
		class armst_bandage_target: Default
		{
			looped = 1;
			mask = "handsWeapon_melee";
			file = "\A3\anims_f\Data\Anim\Sdr\inj\HEALING\AinvPknlMstpSnonWnonDnon_medicUp3";
			speed = 0.15;
			interpolationRestart = 2;
			leftHandIKCurve[] = {};
			rightHandIKCurve[] = {};
		...
		class armst_medkit_0_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_medkit2.rtm";
			speed = 0.18;
			interpolationRestart = 2;
			leftHandIKCurve[] = {};
			rightHandIKCurve[] = {};
		...
		class armst_medkit_10_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_medkit2.rtm";
		...
		class armst_medkit_15_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_medkit2.rtm";
		...
		class armst_medkit_20_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_medkit2.rtm";
		...
		class armst_bandage_0_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_bandage.rtm";
			speed = 0.08;
			interpolationRestart = 2;
			leftHandIKCurve[] = {};
			rightHandIKCurve[] = {};
		...
		class armst_bandage_5_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_bandage.rtm";
		...
		class armst_bandage_10_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_bandage.rtm";
		...
		class armst_injection_0_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_injection.rtm";
			speed = 0.1227;
			interpolationRestart = 2;
			leftHandIKCurve[] = {};
			rightHandIKCurve[] = {};
		...
		class armst_injection_5_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_injection.rtm";
		...
		class armst_injection_10_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_injection.rtm";
		...
		class armst_injection_15_level: Default
		{
			looped = 0;
			mask = "handsWeapon_melee";
			file = "\armst\armst_anim\armst_injection.rtm";
		...
		class Gesture_Remains_0: Default
		{
		...
		class Gesture_Remains_5: Default
		{
			file = "\A3\anims_f\Data\Anim\Sdr\inj\HEALING\AinvPknlMstpSnonWnonDr_medic5";
			looped = 1;
			speed = 0.06;
		...
		class Gesture_Remains_10: Default
		{
			file = "\A3\anims_f\Data\Anim\Sdr\inj\HEALING\AinvPknlMstpSnonWnonDr_medic5";
			looped = 1;
			speed = 0.08;
		...
		class Gesture_Remains_15: Default
		{
			file = "\A3\anims_f\Data\Anim\Sdr\inj\HEALING\AinvPknlMstpSnonWnonDr_medic5";
			looped = 1;
			speed = 0.12;
		...
		class armst_alchogole: Default
		{
			file = "\armst\armst_zdead\zombie_anims\idle.rtm";
			looped = 1;
			speed = 0.1;
			mask = "handsWeapon_melee2";
			limitGunMovement = 0.7;
		...
		class armst_suicide_gesture: Default
		{
			file = "\armst\armst_anim\armst_suicide_gesture.rtm";
			speed = -1e+010;
			disableWeapons = 0;
			looped = 1;
			mask = "handsWeapon_melee2";
